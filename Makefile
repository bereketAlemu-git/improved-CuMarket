objects = main.o Control.o View.o Filter.o Listing.o Price.o Tester.o Category.o CuMarket.o
testobjects = test.o Tester.o TestControl.o View.o Filter.o Listing.o Price.o Category.o CuMarket.o
